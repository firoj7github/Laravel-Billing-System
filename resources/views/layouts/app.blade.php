...
<body>
    ...
    <div id="app">
        <nav style="height:60px;" class="navbar navbar-expand-lg  navbar-expand-md navbar-warning bg-primary bg-gradient">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @guest
                            <li class='nav-item'><a style="color:white; margin-right:13px"  class="nav-link" href="{{ route('login') }}">Login</a></li>
